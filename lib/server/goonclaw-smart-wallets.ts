...
const SMART_WALLET_USER_AGENT = "GoonClaw Smart Wallets/1.0";
...
export async function fetchWalletAnalytics(wallet: string) {
  ...
  try {
    ...
    return {
      ...
      narrativeSummary: "Wallet analytics could not fetch a full smart-money dossier, so GoonClaw stored a lightweight memo only.",
      source: "payer",
